...
- `SPARK_Site/` — the product: 8 self-contained HTML files (open `SPARK_Hub.html`) + project memory. Edit these in place; never split assets out.
- `tools/verify.js` — Playwright verifier. **Every HTML change must pass it before you declare done.**
