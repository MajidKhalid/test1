...
D.activities=B.activityRows.map(r=>B.obj(AF,r));D.activities.forEach(a=>D.images[a.img]=[B.shot(a.url)]);
...
const central={id:'centralBase',label:'Sousse / Kairouan · two nights',dates:'Nights 3–4',badge:'CENTRAL TUNISIA BASE',default:"central-private-medina",options:B.centralRows.map(r=>{const o=B.obj(SF,r);o.images=[B.shot(o.url)];return o})};
