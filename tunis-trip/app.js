...
(() => {
  ...
  const UI = {
    ...
    bookTitle: ['Book', 'الحجوزات'], bookLead: ['Where we sleep, the car, and the tables and tickets the plan needs. The plan itself is kept by the trip bot in the family group: ask it there and every phone updates.', 'أين ننام، والسيارة، والطاولات والتذاكر التي تحتاجها الخطة. الخطة نفسها يحفظها مساعد الرحلة في مجموعة العائلة: اطلبوا منه هناك ويتحدث كل هاتف.'],
    adjust: ['Adjust on this phone', 'تعديل على هذا الهاتف'], adjustLead: ['Change the route, the stays or the car here only if the bot is not around. Changes made here stay on this phone unless you share the link.', 'غيّروا المسار أو الإقامات أو السيارة هنا فقط إن لم يكن المساعد متاحًا. التغييرات هنا تبقى على هذا الهاتف ما لم تشاركوا الرابط.'],
  ...
  const renderBook = () => {
    ...
    const adj = $('#adjustSection'); adj.ontoggle = () => { S.adjustOpen = adj.open; };
