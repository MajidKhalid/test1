...
| T7 | **Twenty flight options ranked around a departure preference** that is now moot. | Medium | Flight shown as **Booked** with editable outbound/return times that feed Day 1 and Day 8. |
